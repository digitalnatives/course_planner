...
var bowerComponentsPaths = require('./bower-components-paths.js');
...
module.exports = function resolve (x, opts, cb) {
    ...
    var modules = opts.moduleDirectory || 'bower_components';
    ...
    else loadBowerComponents(x, y, function (err, n, pkg) {
        if (err) cb(err)
    ...
    function loadBowerComponents (x, start, cb) {
        ...
        })(bowerComponentsPaths(start, opts));
    }
};
