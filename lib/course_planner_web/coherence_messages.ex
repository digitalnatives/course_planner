defmodule CoursePlannerWeb.Coherence.Messages do
  @moduledoc """
  ...
  def incorrect_login_or_password(opts), do: dgettext(@domain,
    "Incorrect %{login_field} or password.", opts)
  def invalid_current_password, do: dgettext(@domain, "invalid current password")
  def invalid_invitation, do: dgettext(@domain,
  ...
  def problem_confirming_user_account, do: dgettext(@domain,
  ...
  def reset_email_sent, do: dgettext(@domain,
  ...
  def too_many_failed_login_attempts, do: dgettext(@domain,
  ...
  def user_account_confirmed_successfully, do: dgettext(@domain,
    "User account confirmed successfully.")
  def user_already_has_an_account, do: dgettext(@domain, "User already has an account!")
  def you_must_confirm_your_account, do: dgettext(@domain,
    "You must confirm your account before you can login.")
  ...
  def verify_user_token(opts), do: dgettext(@domain,
    "Invalid %{user_token} error: %{error}", opts)
  def you_are_using_an_invalid_security_token, do: dgettext(@domain,
