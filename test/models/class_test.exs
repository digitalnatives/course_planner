defmodule CoursePlanner.ClassTest do
  ...
  @valid_course_attrs %{description: "some content", name: "some content", session_duration: %{hour: 14, min: 0, sec: 0}, status: "Planned"}
  ...
  defp create_course do
    ...
    %OfferedCourse{} |> OfferedCourse.changeset(%{course_id: course.id, term_id: term.id, syllabus: "some content", number_of_sessions: 5}) |> Repo.insert
  end
