defmodule CoursePlanner.AttendanceTest do
  ...
  @valid_class_attrs %{offered_course: nil, date: %{day: 17, month: 4, year: 2010}, finishes_at: %{hour: 14, min: 0, sec: 0}, starting_at: %{hour: 15, min: 0, sec: 0}, status: "Planned"}
  ...
  test "changeset with valid attributes" do
    ...
    class = insert(:class, %{@valid_class_attrs | offered_course: offered_course, status: "Active"})
