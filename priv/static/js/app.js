...
window.onload = function () {
  var removeElement = function removeElement(_ref) {
  ...
  Array.from(document.querySelectorAll(".add-form-field")).forEach(function (el) {
    el.onclick = function (_ref2) {
      var dataset = _ref2.target.dataset;
